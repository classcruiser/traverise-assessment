    ...
    <div class="content-wrapper container">
        <div class="content">
            <div class="card">
                ...
                <form action="{{ route('tenant.roles.insert') }}" method="post">
                                    ...
                                    @foreach ($permissions as $permission)
                                        <div class=" py-2 px-3 border-bottom-1 border-alpha-grey">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input checkbox-permission checkbox-{{ $permission->id }}" id="permission-{{ $permission->id }}" name="permissions[{{ $permission->name }}]">
                    ...
                    @can ('save setting')
                        <div class="card-body">
                            <div class="text-right">
                                @csrf
                                <button class="btn bg-danger" type="submit">Create Role</button>
                            </div>
                        </div>
                    @endcan
                </form>
