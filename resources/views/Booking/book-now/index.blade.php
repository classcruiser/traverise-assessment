...
<div class="header fixed md:absolute with-overlay-bottom h-[400px] left-0 top-0 w-full" style="background: url({{ asset('front/'. tenant('id') .'_header.jpg?'. date('Ymd')) }}) center center no-repeat; background-size: cover;">
    &nbsp;
</div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card sidebar-stick" data-margin-top="94">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-end">
                                <div class="w-100 mr-1">
                                    ...
                                    @endif
                                    <div class="w-100 d-flex justify-content-between align-items-center">
                                        <div>5% Cultural tax</div>
                                        <div style="font-size: 1.2em;">
                                            <b>&euro;{{ number_format($booking_room['tax'], 2) }}</b>
                                        </div>
                                    </div>
                                </div>
                                @if ($step < 6)
                        ...
                        <div class="card-body">
                            ...
                            <p>Thanks! Our team will apply the voucher on your booking and you will receive a revised booking confirmation email!</p>
                            <p><b>CODE</b>: <b class="text-custom">{{ $booking_room['voucher'] }}</b><br />
                                <a href="#" title="" class="cancel-voucher text-grey d-inline-block border-top-0 border-left-0 border-right-0 border-dashed border-bottom-1">cancel ?</a></p>
                                @else
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <span class="font-size-xl font-weight-bold text-custom" id="grand-total">
                                        <b>&euro;{{ number_format(floatVal($booking_room['price']) + floatVal($booking_room['tax']) + floatVal($total_addon) + floatVal($total_transfer), 2) }}</b>
                                    </span>
                                </div>
