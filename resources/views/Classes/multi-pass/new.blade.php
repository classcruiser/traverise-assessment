                ...
                <div class="card-body border-0 p-0">
                    <div class="tab-content">
                        <div class="tab-pane active">
                            ...
                            <form action="{{ route('tenant.classes.multi-pass.store') }}" method="POST">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label>* Amount</label>
                                                        <input type="text" name="amount" placeholder="Amount" class="form-control @error('amount') is-invalid @enderror" maxlength="255" required value="{{ old('amount') }}">
                                                        @error('amount')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label>* Price</label>
                                                        <input type="text" name="price" placeholder="Price" class="form-control @error('price') is-invalid @enderror" maxlength="255" required value="{{ old('price') }}">
                                                        @error('price')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" id="pass-code" name="code" placeholder="Pass Code" class="form-control @error('code') is-invalid @enderror" maxlength="255" value="{{ old('code') }}" aria-label="Pass Code" aria-describedby="btn-generate-passcode">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select-no-search" data-fouc data-placeholder="Only for" name="class_session_id">
                                                            ...
                                                            @foreach ($sessions as $session)
                                                                @if ($session->category)
                                                                    <option value="{{ $session->id }}" {{ old('class_session_id') == $session->id ? 'selected' : '' }}>{{ $session->category->name }} &raquo; {{ $session->name }}</option>
                                                                @endif
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="d-flex justify-content-start">
                                                            <input type="text" min="0" name="expiry_amount" class="form-control mr-2" placeholder="1" value="{{ old('expiry_amount') }}" style="width: 50px;">
                                                            <select class="form-control select-no-search" data-fouc data-placeholder="Expiry type" name="expiry_type">
                                                                <option>No expire limit</option>
                                                                @foreach ($expiry_types as $type)
                                                                    <option value="{{ $type }}" {{ old('expiry_type') == $type ? 'selected' : '' }}>{{ $type }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
