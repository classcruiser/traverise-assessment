        ...
        <div class="content-wrapper">
            <div class="content">
                <div class="mb-2 py-1 px-2 d-flex justify-content-end align-items-center">
                    <h4 class="m-0 mr-auto d-none d-md-block"><i class="fal fa-fw fa-calendar-alt mr-1"></i> All Draft Bookings</h4>
                    <button class="btn btn-labeled btn-labeled-left bg-orange-400 ml-1 collapsed d-none" data-toggle="collapse" href="#advanced-search">
