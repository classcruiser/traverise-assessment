<div id="modal_edit_schedule_{{ $schedule->id }}" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('tenant.classes.sessions.schedules.update', ['id' => $record->id, 'scheduleId' => $schedule->id]) }}" class="form-horizontal" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="col-form-label custom-control custom-checkbox">
                                <input type="checkbox" name="is_active" value="1" class="custom-control-input" id="schedule-active_{{ $schedule->id }}" @checked($schedule->is_active) >
                                <label class="custom-control-label" for="schedule-active_{{ $schedule->id }}"></label>
                            </div>
                        </div>
                    </div>
