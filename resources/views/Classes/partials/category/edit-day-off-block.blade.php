<div id="modal_edit_day_off_block_{{ $schedule->id }}" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-grey-800">
                <h5 class="modal-title">Edit Day Off Schedule</h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>

            <form action="{{ route('tenant.classes.categories.day_off_schedules.update', ['id' => $category->id, 'scheduleId' => $schedule->id]) }}" class="form-horizontal" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group input-group-sm" style="width: 270px">
                                ...
                                <input type="text" class="form-control date-time-picker" name="date" value="{{ $schedule->date?->format('d.m.Y') }}" autocomplete="off" placeholder="Schedule Date" required>
                            </div>
                        </div>
                    </div>
